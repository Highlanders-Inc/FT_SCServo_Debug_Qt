...
// ─── レジスタ名でアドレスを検索するユーティリティ ────────────────────────────
// 各シリーズの MemoryConfig から name に一致するエントリのアドレスを返す。
// 見つからない場合は fallback を返す。
inline uint8_t findRegisterAddress(const std::vector<MemoryConfig>& config,
                                   const QString& name,
...
// ─── SMXX (SMCL 系: SM30-360M など) ──────────────────────────────────────────
const std::vector<MemoryConfig> SMCLMemConfig =
{
    {0,  "Firmware Main Version NO.",    1, 0,    -1, true,  true,  -1,    -1},
    ...
    {48, "Lock",                         1, 1,    -1, false, false, 0,     1},   // LOCK=48
...
const std::vector<MemoryConfig> SMBLMemConfig =
{
    ...
    {55, "Lock",                         1, 1,    -1, false, false, 0,     1},   // LOCK=55
    {56, "Present Position",             2, 0,    15, false, true,  -1,    -1},
    {58, "Present Velocity",             2, 0,    15, false, true,  -1,    -1},
    {60, "Present PWM",                  2, 0,    10, false, true,  -1,    -1},
    {62, "Present Input Voltage",        1, 0,    -1, false, true,  -1,    -1},
...
// ─── STSXX (STS 系: STS3215, STS3032 など) ────────────────────────────────────
...
// ─── SCSXX (SCS 系: SCS0009, SCS15, SCS009 など) ─────────────────────────────
...
// ─── HLSCL (HLS 系: HLS36, HLS40BLH, HLS45L など) ────────────────────────────
// 出典: Feetech 公式 FTServo_Arduino/src/HLSCL.h
// STS 系との主な違い:
//   - addr  7: Second ID (サブID)
//   - addr 44-45: Goal Torque (STS は Goal Time)
//   - Work Mode 2 = 恒力モード (WriteEle)
//   - LOCKアドレスは STS と同じ 55
const std::vector<MemoryConfig> HLSMemConfig =
{
    ...
    {3,  "Servo Main Version",           1, 0,    -1, true,  true,  -1,    -1},
    {4,  "Servo Sub Version",            1, 0,    -1, true,  true,  -1,    -1},
    {5,  "ID",                           1, 1,    -1, true,  false, 0,     253},
    {6,  "Baud Rate",                    1, 4,    -1, true,  false, 0,     7},
    {7,  "Second ID",                    1, 0,    -1, true,  false, 0,     253},  // HLS 固有
    {9,  "Min Position Limit",           2, 0,    15, true,  false, -1,    -1},
    {11, "Max Position Limit",           2, 0,    15, true,  false, -1,    -1},
    {26, "CW Dead Band",                 1, 0,    -1, true,  false, 0,     32},
    {27, "CCW Dead Band",                1, 0,    -1, true,  false, 0,     32},
    {31, "Position Offset Value",        2, 0,    15, true,  false, -2047, 2047},
    {33, "Work Mode",                    1, 0,    -1, true,  false, 0,     2},   // 0=servo 1=wheel 2=force
    {40, "Torque Enable",                1, 0,    -1, false, false, 0,     254},
    {41, "Goal Acceleration",            1, 0,    -1, false, false, 0,     254},
    {42, "Goal Position",                2, 0,    15, false, false, -32766,32766},
    {44, "Goal Torque",                  2, 0,    -1, false, false, 0,     1000}, // HLS 固有 (STSはGoal Time)
    {46, "Goal Speed",                   2, 0,    15, false, false, -1000, 1000},
    {48, "Torque Limit",                 2, 1000, -1, false, false, 0,     1000},
    {55, "Lock",                         1, 1,    -1, false, false, 0,     1},   // LOCK=55
    {56, "Present Position",             2, 0,    15, false, true,  -1,    -1},
    {58, "Present Speed",                2, 0,    15, false, true,  -1,    -1},
    {60, "Present Load",                 2, 0,    10, false, true,  -1,    -1},
    {62, "Present Input Voltage",        1, 0,    -1, false, true,  -1,    -1},
    {63, "Present Temperature",          1, 0,    -1, false, true,  -1,    -1},
    {66, "Moving Status",                1, 0,    -1, false, true,  -1,    -1},
    {69, "Present Current",              2, 0,    15, false, true,  -1,    -1},
